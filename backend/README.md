...
## Project Structure
    ...
    ├── testapiautoconnect_123251  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_123251`
...
2. Clone this repo and `cd testapiautoconnect_123251`
